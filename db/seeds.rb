...
User.create!([
  ...
  {name: "一般ゲスト", number: 1000000004, email: "general_guest@example.com", password: "password", admin: false},
  {name: "全権限ゲスト", number: 1000000005, email: "full_authority_guest@example.com", password: "password", admin: true}
])
...
Product.create!([
  {
    ...
    reference_image: File.open("./app/assets/images/food_caesar_salad.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 1,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_reisyabu_salad.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 1,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_potato_sald.jpg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 2,
    application_status: 1,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_vegetable_coleslaw_salad.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 2,
    application_status: 2,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/soup_minestrone.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 3,
    application_status: 1,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/soup_wakame.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 3,
    application_status: 2,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_hourensou_gomaae.jpg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 4,
    application_status: 1,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_shiraae.jpg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 4,
    application_status: 2,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_spaghetti_carbonara.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 5,
    application_status: 1,
  ...
  },
  {
    ...
    reference_image: File.open("./app/assets/images/food_yakisoba.jpeg"),
    status: 1,
    client_id: rand(1..3),
    category_id: 5,
    application_status: 2,
...
Negotiation.create!([
  {
    ...
    selling_price: 298,
    wholesale_price: 149,
    product_image: File.open("./app/assets/images/food_reisyabu_salad.jpeg"),
  ...
  },
  {
    ...
    selling_price:  198,
    wholesale_price: 9,
    product_image: File.open("./app/assets/images/food_vegetable_coleslaw_salad.jpeg"),
  ...
  },
  {
    ...
    selling_price: 198,
    wholesale_price: 99,
    product_image: File.open("./app/assets/images/soup_wakame.jpeg"),
  ...
  },
  {
    ...
    selling_price: 198,
    wholesale_price: 99,
    product_image: File.open("./app/assets/images/food_shiraae.jpg"),
  ...
  },
  {
    ...
    selling_price: 298,
    wholesale_price: 149,
    product_image: File.open("./app/assets/images/food_yakisoba.jpeg"),
